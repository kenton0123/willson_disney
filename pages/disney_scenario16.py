...
def main():
    ...
    st.markdown(
        """
            <div class="title">
                Instruction: Please copy the following question to receive background information: <span class="blue-bg">"Discuss the history of Disneyland Paris, including its facilities, visitor numbers, and notable recent events."</span>
            </div>
            """,
        unsafe_allow_html=True
    )
    st.caption(
        "Scenario 16 | High Information Completeness | High Source Quality | High AI Self Rating | High AI Public Rating")
